...
void process_calculate_xs_events_nonfuel()
{
  ...
  const int n_particles = simulation::calculate_nonfuel_xs_queue.size();
  #pragma omp target teams distribute parallel for
  for (int i = 0; i < n_particles; i++) {
...
void process_calculate_xs_events_fuel()
{
  ...
  const int n_particles = simulation::calculate_fuel_xs_queue.size();
  #pragma omp target teams distribute parallel for
  for (int i = 0; i < n_particles; i++) {
...
void process_advance_particle_events()
{
  ...
  const int n_particles = simulation::advance_particle_queue.size();
  #pragma omp target teams distribute parallel for
  for (int i = 0; i < n_particles; i++) {
...
void process_surface_crossing_events()
{
  ...
  const int n_particles = simulation::surface_crossing_queue.size();
  #pragma omp target teams distribute parallel for
  for (int i = 0; i < n_particles; i++) {
...
void process_collision_events()
{
  ...
  const int n_particles = simulation::collision_queue.size();
  #pragma omp target teams distribute parallel for
  for (int i = 0; i < n_particles; i++) {
...
void process_revival_events()
{
  ...
  const int n_particles = simulation::revival_queue.size();
